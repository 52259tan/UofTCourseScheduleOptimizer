 ...
 * @author Joshua Jang
 */
public class GoogleMapRenderAPI implements MapRenderAPI{
    private String encodeLocations(List<String> locations) {
    ...
    private String extractFirstPolyline(JSONObject responseBody) {
