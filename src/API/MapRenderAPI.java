...
public class MapRenderAPI {
     ...
     */
    public static BufferedImage generateMapWithPolyline(String encodedPolyline) {
        final String API_URL =
                "https://maps.googleapis.com/maps/api/staticmap?size=600x400&&path=color:0x0000ff|weight:4|enc:%s&key=%s";

        OkHttpClient client = new OkHttpClient().newBuilder().build();
        Request request = new Request.Builder()
                .url(String.format(API_URL, encodedPolyline, APIKeys.GOOGLE_MAPS_KEY))
                .build();
        try {
