...
import static algorithm.AllPossibleTimeTables2.getAllTimeTable;
import static algorithm.getDistances.getDistance;

/** This class return a TimeTable object that contains the global optimal choice with the endTime before 8pm based on the courses that the user input
 * @author ping
 */
...
public class Algorithm2 implements AlgorithmInterface{
     ...
     */
    @Override
    public TimeTable getOptimalChoice(List<Course> courses) {
